...
protected:
	...
	void treeSearch(Solution &sln, int depth, int iterTime);
	Price callModel(const Arr2D<int> &visits);
	Price callLKH(const Solution &sln, const Arr2D<int> &visits, int p);
